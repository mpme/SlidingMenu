 ...
 */
public class ActionBarSlidingMenuToggle {

    /**
     * Allows an implementing Activity to return an {@link ActionBarSlidingMenuToggle.Delegate} to use
    ...
    private static class ActionBarDrawerToggleImplHC implements ActionBarDrawerToggleImpl {
        @Override
        public Drawable getThemeUpIndicator(Activity activity) {
            return ActionBarSlidingMenuToggleHoneycomb.getThemeUpIndicator(activity);
        }

        @Override
        public Object setActionBarUpIndicator(Object info, Activity activity,
                                              Drawable themeImage, int contentDescRes) {
            return ActionBarSlidingMenuToggleHoneycomb.setActionBarUpIndicator(info, activity,
                    themeImage, contentDescRes);
        }

        @Override
        public Object setActionBarDescription(Object info, Activity activity, int contentDescRes) {
            return ActionBarSlidingMenuToggleHoneycomb.setActionBarDescription(info, activity,
                    contentDescRes);
        }
    }
     ...
     *                                  for accessibility
     */
    public ActionBarSlidingMenuToggle(Activity activity, SlidingMenu slidingMenu,
    ...
    public void syncState() {
        ...
        if (mDrawerIndicatorEnabled) {
            setActionBarUpIndicator(mSlider, mSlidingMenu.isMenuShowing() ?
